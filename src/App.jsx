...
const InventoryApp = () => {
      ...
      for (const shopifyProduct of shopifyProducts) {
        ...
        if (existing) {
          ...
          const newProduct = {
            ...
            unusable_stock: 0,
            hold_stock: 0,
            design: shopifyProduct.product_type || 'Product',
            color: '',
            reorder_level: 5,
            supplier: ''
          };
  ...
  // PUSH TO SHOPIFY - Matches by product name
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', padding: '20px', maxWidth: '1400px', margin: '0 auto' }}>
      <div style={{ marginBottom: '30px' }}>
        <h1 style={{ margin: '0 0 5px 0', fontSize: '28px' }}>Inventory Management System</h1>
        <p style={{ margin: 0, color: '#666' }}>Track inventory with multi-category stock management & Shopify sync</p>
        {shopifyConnected && (
